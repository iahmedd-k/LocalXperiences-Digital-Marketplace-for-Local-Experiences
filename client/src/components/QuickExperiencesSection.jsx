  ...
  return (
    <section className="px-4 py-10 sm:px-6">
      <div className="mx-auto max-w-[1280px]">
        <div className="mb-5">
          <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-amber-700">Quick Experiences</p>
          <h2 className="mt-1 text-2xl font-bold text-slate-900">Under 1 hour</h2>
        </div>
