...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const firstName = data.data.user.name?.split(' ')[0] || 'there'
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-500 mb-8">Sign in to continue exploring local experiences</p>
      ...
      <div className="hidden lg:flex flex-1 bg-gray-900 items-center justify-center relative overflow-hidden">
        <div
          ...
          style={{ background: 'radial-gradient(ellipse at 40% 60%, rgba(249,115,22,0.3) 0%, transparent 60%)' }}
        />
        <div className="relative text-center px-12">
          <div className="text-7xl mb-6">🌍</div>
          <h2 className="font-clash text-4xl font-bold text-white mb-4">
            Sign in &amp;<br />
            Start Exploring
          </h2>
          <p className="text-gray-400 text-lg">
            Pick up where you left off and discover new experiences tailored to you.
          </p>
        </div>
      </div>
    </div>
